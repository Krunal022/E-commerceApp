...
public class ShippingActivity extends AppCompatActivity implements PaymentResultWithDataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paymentType = findViewById(R.id.shipping_payment);
    ...
    private void createOrderMethod(String transactionid) {
        String insertQuery = "INSERT INTO SHIPPING_ORDER VALUES(NULL,'" + sp.getString(ConstantSp.ID, "") + "','" + name.getText().toString() + "','" + email.getText().toString() + "','" + contact.getText().toString() + "','" + address.getText().toString() + "','" + Scity + "','" + CartFragment.iTotalPrice + "','" + sPaymentType + "','"+transactionid+"')";

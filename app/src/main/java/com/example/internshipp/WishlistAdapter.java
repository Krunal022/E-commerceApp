...
public class WishlistAdapter extends RecyclerView.Adapter<WishlistAdapter.MyHolder> {
    ...
    SQLiteDatabase db;
    public WishlistAdapter(Context context, ArrayList<Whishlist> arrayList) {
        this.context = context;
        this.arrayList=arrayList;
        sp = context.getSharedPreferences(ConstantSp.PREF,Context.MODE_PRIVATE);


        db= context.openOrCreateDatabase("On_Internshipp", Context.MODE_PRIVATE,null);
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custome_wishlist,parent,false);

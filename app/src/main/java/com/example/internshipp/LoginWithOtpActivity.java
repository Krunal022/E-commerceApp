...
public class LoginWithOtpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rememberMe = findViewById(R.id.login_with_otp_checkbox);


        signup = findViewById(R.id.login_with_otp_sign_up);
...
//                        Toast.makeText(LoginWithOtpActivity.this, "Login Sucessfully", Toast.LENGTH_SHORT).show();
//                        Snackbar.make(view, "login sucessfully", Snackbar.LENGTH_SHORT).show();
//                        Intent intent = new Intent(LoginWithOtpActivity.this, DashboardActivity.class);
//                        startActivity(intent);
